...
class DatabaseManager:
    ...
    def make_engine(self):
        ...
        if not database_exists("mysql+pymysql://root:mft123@localhost:3306/mft"):
            create_database("mysql+pymysql://root:mft123@localhost:3306/mft")

        self.engine = create_engine("mysql+pymysql://root:mft123@localhost:3306/mft")
